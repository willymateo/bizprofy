...
import {
  ...
  Warehouse,
} from "@/services/warehouses/interfaces";

interface Props extends GetWarehousesPayload, GetWarehousesResponse {
  className?: string;
}
...
const Table = ({
  ...
  const [selectedRows, setSelectedRows] = useState<Record<string, Warehouse>>({});
